...
<jstl:if test="${flugots.isEmpty() == true}">
...
<jstl:if test="${flugots.isEmpty() == false}">
	<security:authentication property="principal.username" var="username" />
	<jstl:if
		test='${flugots.get(0).auditor.userAccount.username == username || flugots.get(0).audit.position.company.userAccount.username == username || flugot.id == 0}'>
		<security:authorize access="hasAnyRole('AUDITOR','COMPANY')">
<display:table name="flugots" id="flugot" requestURI="${RequestURI}"
	pagesize="${numResults}" class="displaytag">
...
<input type="button" name="back"
	...
	<jstl:if
		test='${ flugots.get(0).audit.position.company.userAccount.username != username}'>
		<jstl:if
