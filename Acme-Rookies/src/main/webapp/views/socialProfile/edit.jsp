...
<form:form action="${requestURI}" modelAttribute="socialProfile">
	<jstl:if test='${res == false}'>
		<spring:message code="wrong.user"></spring:message>
		<br>
		<br>
		<acme:cancel code="socialProfile.back" url="/socialProfile/list.do" />
		<br>
		<br>
	</jstl:if>

	<jstl:if test='${res == true || isRead == true || create == true}'>
